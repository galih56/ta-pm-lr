<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
    <div class="sidebar-inner px-2 pt-1">
        ...
        <ul class="nav flex-column pt-3 pt-md-0">
            <li class="nav-item">
                <a href="{{url('/master')}}" class="nav-link nav_link d-flex align-items-center">
                    <span class="mt-1 ms-1 sidebar-text"> MANPRO </span>
                </a>
            </li>
            <li class="nav-item">
                <span class="nav-link nav_link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-proyek">
                    <span>            
                    ...
                    <div class="multi-level collapse  {{ (Request::segment(2)=='projects'||Request::segment(2)=='lists') ? 'show' : '' }}" role="list" id="submenu-proyek" aria-expanded="false">
                        <ul class="flex-column nav">
                            <li class="nav-item {{ (Request::segment(2)=='projects') ? 'active' : '' }}">
                                <a href="{{route('projects.index')}}" class="nav-link nav_link">
                                    <span>
                                        <span class="sidebar-icon">
                            ...
                            <li class="nav-item {{ (Request::segment(2)=='lists') ? 'active' : '' }}">
                                <a href="{{route('lists.index')}}" class="nav-link nav_link">
                                    <span>
                                        <span class="sidebar-icon">
            ...
            <li class="nav-item {{ Request::segment(2)=='clients' ? 'active' : '' }}">
                <a href="{{route('clients.index')}}" class="nav-link nav_link">
                    <span>
                        <span class="sidebar-icon">
            ...
            <li class="nav-item {{ Request::segment(2)=='teams' ? 'active' : '' }}">
                <a href="{{route('teams.index')}}" class="nav-link nav_link">
                    <span>
                        <span class="sidebar-icon">
            ...
            <li class="nav-item">
                <span class="nav-link nav_link collapsed d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#submenu-autentikasi">
                    <span>            
                        <span class="sidebar-icon">
                    ...
                    <div class="multi-level collapse  {{ (Request::segment(2)=='users'||Request::segment(2)=='roles') ? 'show' : '' }}" role="list" id="submenu-autentikasi" aria-expanded="false">
                        <ul class="flex-column nav">
                            <li class="nav-item {{ (Request::segment(2)=='users') ? 'active' : '' }}">
                                <a href="{{route('users.index')}}" class="nav-link nav_link">
                                    <span>
                            ...
                            <li class="nav-item {{ (Request::segment(2)=='roles') ? 'active' : '' }}">
                                <a href="{{route('roles.index')}}" class="nav-link nav_link">
