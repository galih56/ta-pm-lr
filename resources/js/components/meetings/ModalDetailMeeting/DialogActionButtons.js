...
const dialogActionButtons = ({ isEdit, saveChanges, setEditMode, deleteMeeting, deleteConfirmOpen, setDeleteConfirmOpen, closeModal }) => {
    if (isEdit) {
        return (
            <React.Fragment>
                ...
                <ModalDeleteConfirm
                    ...
                    handleDelete={() => { deleteMeeting(); setDeleteConfirmOpen(false); closeModal(); }}
