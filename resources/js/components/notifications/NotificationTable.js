...
export default function EnhancedTable() {
    ...
    const getNotifications = () => {
        ...
        const url = `${process.env.MIX_BACK_END_BASE_URL}notifications?users_id=${global.state.id}`;
                                            ...
                                            return (
                                                <TableRow hover key={row.id}>
                                                    <TableCell component="th" scope="row" style={{ cursor: 'pointer' }}>
                                                        <Link to={`/notifications/${row.id}`} style={{textDecoration:'none'}}><b>{row.title}</b></Link>
                                                        <br/>
                                                        {row.message}
                                                    </TableCell>
                                                    <TableCell align="left">{row.read_at ? moment(row.read_at).format('DD MMM YYYY') : ''}</TableCell>
