...
const dialogActionButtons = ({ isEdit, saveChanges, setEditMode, deleteMember, deleteConfirmOpen, setDeleteConfirmOpen, closeModal }) => {
    if (isEdit) {
        return (
            <React.Fragment>
                ...
                <ModalDeleteConfirm
                    ...
                    handleDelete={() => { deleteMember(); setDeleteConfirmOpen(false); closeModal(); }}
